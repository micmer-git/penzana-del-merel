    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'morellino', nameIT: 'Morellino Pradella', nameEN: 'Morellino Pradella', price: 20.0, descIT: '', descEN: '' },
          { id: 'santa-cristina', nameIT: 'Santa Cristina 1/2 litro', nameEN: 'Santa Cristina 1/2 litre', price: 12.0, descIT: '', descEN: '' },
          { id: 'valcalepio', nameIT: 'Valcalepio Caffi', nameEN: 'Valcalepio Caffi', price: 20.0, descIT: '', descEN: '' },
        ],
      },
      {
        id: 'vini-bianchi',
        ...
        items: [
          ...
          { id: 'lugana', nameIT: 'Lugana', nameEN: 'Lugana', price: 22.0, descIT: '', descEN: '' },
          { id: 'ferrari-brut', nameIT: 'Ferrari Spumante Brut', nameEN: 'Ferrari Spumante Brut', price: 30.0, descIT: '', descEN: '' },
        ],
      },
    ],
  },
